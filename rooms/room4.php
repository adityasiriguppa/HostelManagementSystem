...
<?php
$result1 = mysql_query("select roomno,status from rooms where status=0 and roomno>400");
/*if($result1){echo "1";}*/
...
<form name="frmdropdown" method="post" action="new1.php">
     <center>
            ...
            <?php
                 ...
                 $dd_res=mysql_query("Select roomno from rooms where status=0 and roomno>400");
